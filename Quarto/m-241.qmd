...
これはハードウェア側がファームウェアアップデートすることで対応できる話ではあるが，このGPSロガーのメーカーは[倒産した](https://www.yamareco.com/modules/diary/148886-detail-192657){target="_blank"}そうである。
このため，ユーザー側でエクスポートしたファイルに何らかの方法で1024週追加して，時間を後ろにずらす必要がある。
