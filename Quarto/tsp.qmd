...
ehime_map0 <- read_sf("N03-20250101_38_GML/N03-20250101_38.shp", options = "ENCODING=CP932")
office_map0 <- read_sf("P34-14_38_GML/P34-14_38.shp", options = "ENCODING=CP932")
```
```{r}
#| include: false
library(sf)

ehime_map0 <- read_sf("../data/N03-20250101_38_GML/N03-20250101_38.shp", options = "ENCODING=CP932")
...
ehime_map <- readKSJData("N03-20250101_38_GML.zip")
...
ehime_map <- readKSJData("../data/N03-20250101_38_GML.zip")
