...
筆ポリゴンのファイル名には，年度と全国地方公共団体コードによって構成されている。
...
ここで実際に，先ほど読み込んだ筆ポリゴンのリストの名前を日本語に変更してみる。
...
「筆ポリゴンデータ（2022年度公開 ArcGIS Online版）」（農林水産省）（`r format(Sys.time(), '%Y年%m月%d日')`に利用）。

「筆ポリゴンデータ（2022年度公開 ArcGIS Online版）」（農林水産省）を加工して作成。
:::
